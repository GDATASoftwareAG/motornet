...
namespace Motor.Extensions.Hosting.Kafka_IntegrationTest
{
    ...
    public class KafkaConsumerTests : IClassFixture<KafkaFixture>
    {
        ...
        public KafkaConsumerTests(KafkaFixture fixture) => _fixture = fixture;
        ...
        {
            using var producer = new ProducerBuilder<string, string>(new ProducerConfig {BootstrapServers = $"{_fixture.Hostname}:9092"}).Build();
